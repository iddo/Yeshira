...
# The script assumes debian based linux in 64bit architecture. IT WILL NOT WORK ON ANY DIFFERENT CONFIGURATION.
# Please change the relevant commands to make them work on other system configurations.
#
